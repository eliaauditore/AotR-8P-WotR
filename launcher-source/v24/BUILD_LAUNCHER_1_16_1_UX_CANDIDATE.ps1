...
$text = Replace-Once $text '[string]$LauncherVersion = "1.1.4"' '[string]$LauncherVersion = "1.16.1"' 'version default'
$text = Replace-Once $text '"_V21_1_1_4_BUILD"' '"_V24_1_16_1_BUILD"' 'default output root'
...
$text = Replace-Once $text 'Assert-Hash (Join-Path $Resources "launcher_gui.ps1") "585E3D43B407E2E7A26D6B8B6B4D8F06952C81EA58847B21AE71BC6BC54A4A24" "Frozen 1.1.3 GUI"' 'Assert-Hash (Join-Path $Resources "launcher_gui.ps1") "8A31D3EDC48B5915AC552EFB26DFF48CEABB1022D24C0A90834930117046A2AA" "Frozen public 1.1.6 GUI"' 'donor GUI identity'
$text = Replace-Once $text 'Assert-Hash (Join-Path $Resources "launcher_engine.ps1") "5DB2F749F10E84322BC471FFF04E25326EFF194FA440175FE9841ED13367F938" "Frozen 1.1.3 engine"' 'Assert-Hash (Join-Path $Resources "launcher_engine.ps1") "E9E2452FF56A66D57FF63C0B1654CFE0C856F4D5FA66C558E8F237C9ABABF641" "Frozen public 1.1.6 engine"' 'donor engine identity'
...
'@
$newTransform = @'
& $Python (Join-Path $PSScriptRoot "apply_1_16_1_ux.py") (Join-Path $Resources "launcher_gui.ps1")
if ($LASTEXITCODE -ne 0) { throw "Launcher 1.16.1 UX transform failed" }
'@
$text = Replace-Once $text $oldTransform $newTransform 'transform invocation'
$text = Replace-Once $text 'Write-Host "V21 ISSUE78 CANDIDATE PASS" -ForegroundColor Green' 'Write-Host "V24 1.16.1 UX CANDIDATE PASS" -ForegroundColor Green' 'final PASS label'
