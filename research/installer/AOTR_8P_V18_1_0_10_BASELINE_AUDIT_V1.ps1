...
function Show-MarkerTable([string]$Label,[string]$Text,[hashtable]$Markers) {
    Write-Host ''
...
Write-Host ' AOTR 8P V18 / 1.0.10 AUTHORITATIVE BASELINE AUDIT V1' -ForegroundColor Cyan
...
if (@($critical.Values | Where-Object { -not $_ }).Count -gt 0) {
