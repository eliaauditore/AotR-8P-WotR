...
$patchedText = $patchedText.Replace('[string]$LauncherVersion = \"1.1\",','[string]$LauncherVersion = "1.1",')
...
$roundTrip = $roundTrip.Replace('[string]$LauncherVersion = \"1.0.0\",','[string]$LauncherVersion = "1.0.0",')
...
Write-Host ' STAGE 13 V1.6 DIRECT FINAL BUILDER STAGING: PASS' -ForegroundColor Green
Write-Host '============================================================' -ForegroundColor Green
