...
Write-Host ' AOTR 8P STAGE 3 STATUS PANEL DONOR SELECTOR V5.1' -ForegroundColor Cyan
...
$report = Join-Path $EvidenceRoot 'STATUS_PANEL_DONOR_SELECTOR_V5_1.txt'
$summary = @()
$summary += 'AOTR 8P STATUS PANEL DONOR SELECTOR V5.1'
...
Write-Host ' DONOR SELECTOR V5.1 COMPLETE' -ForegroundColor Green
Write-Host '============================================================' -ForegroundColor Green
